      ...
      const res = await fetch(`${API_BASE_URL}/api/diagnostico`, {
        ...
        body: JSON.stringify({ 
          ...
          datos: { 
            ...
            contexto,
            sintomas,
            instruccion: PREGUNTAS REALIZADAS: {preguntas}
RESPUESTAS DEL OPERARIO: {respuestas}

Analiza hallazgo por hallazgo.
Usa lenguaje de ingeniería moderado:
"desviación detectada", "condición 
a monitorear". JAMÁS: catastrófico,
urgente, grave, peligro.

RESPONDE SÓLO con este JSON:
{
  "titulo": "Diagnóstico Prelim. de X",
  "resumen_ejecutivo": "...",
  "analisis_6m": {
...
nivel_criticidad = Alto si >3 M 
presentan hallazgos fuera de rango.
            }`
          } 
        })
      });
